...
{
    public sealed class AgentPropertyService : GenericServices<SavePropertyDto, Property, int>, IAgentPropertyService
    {
        ...
        private readonly ILogger<AgentPropertyService> _logger;
        ...
        public AgentPropertyService(
            ...
            ILogger<AgentPropertyService> logger)
        ...
        public override async Task<ValidationResult> AddAsync(SavePropertyDto dto)
        {
            ...
            {
                _logger.LogError(ex, "Ocurrió un error en AgentPropertyService");
        ...
        public override async Task<ValidationResult<SavePropertyDto>> GetByIdAsync(int id)
        {
            ...
            {
                _logger.LogError(ex, "Ocurrió un error en AgentPropertyService.GetByIdAsync");
        ...
        public async Task<ValidationResult<int>> CountByAgentAsync(string agentId)
        {
            ...
            {
                _logger.LogError(ex, "Ocurrió un error en AgentPropertyService.CountByAgentAsync");
        ...
        public async Task<ValidationResult<int>> CountByAgentAndStatusAsync(string agentId, RealEstateApp.Core.Domain.Common.Enums.PropertyStatus.PropertyState status)
        {
            ...
            {
                _logger.LogError(ex, "Ocurrió un error en AgentPropertyService.CountByAgentAndStatusAsync");
                return ValidationResult<int>.Failure(new List<Error> { new Error("Oops", "Al parecer esta función no está disponible en este momento. Favor intente más tarde.") });
            }
        }
    }
